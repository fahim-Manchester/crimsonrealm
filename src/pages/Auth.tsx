        ...
        <div className="gothic-card p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <p className="font-crimson text-muted-foreground italic">
              {isForgotPassword ? "Reset your password" : isLogin ? labels.authWelcomeBack : labels.authJoin}
            </p>
          </div>
                ...
                {isLogin && (
                  <div className="text-right">
                    <button
                      ...
                      className="text-muted-foreground hover:text-primary text-sm font-crimson transition-colors"
                    >
                      Forgot password?
                    </button>
                  </div>
