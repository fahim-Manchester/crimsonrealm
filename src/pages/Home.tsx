...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {theme === "gothic" && <div className="absolute inset-0 bg-gradient-fog opacity-50" />}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <h1 className="text-gothic-title text-3xl md:text-5xl mb-4">
                Welcome to the <span className="text-primary">{labels.homeName}</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              {/* Chronicles / Intel Files / Scrolls / Briefs */}
              <Link to="/resources" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.resources}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.resourcesDesc}</p>
              </Link>

              {/* Forge / Hit List / Quests / Action Items */}
              <Link to="/tasks" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.tasks}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.tasksDesc}</p>
              </Link>

              {/* Campaign / Raids / Adventures / Sprints */}
              <Link to="/campaigns" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.campaigns}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.campaignsDesc}</p>
              </Link>

              {/* Territories / Operations / Lands / Portfolios */}
              <Link to="/projects" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.projects}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.projectsDesc}</p>
              </Link>

              {/* Achievements / Trophies / Honors / Milestones */}
              <Link to="/achievements" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.achievements}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.achievementsDesc}</p>
              </Link>

              {/* Diary / Logs / Journal / Memos */}
              <Link to="/diary" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.diary}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.diaryDesc}</p>
              </Link>

              {/* The Codex / Field Manual / Lore Book / Handbook */}
              <Link to="/codex" className="gothic-card p-6 group hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-sm bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  ...
                  <h3 className="font-cinzel text-lg tracking-wide text-foreground">{labels.codex}</h3>
                </div>
                <p className="font-crimson text-muted-foreground">{labels.codexDesc}</p>
              </Link>
            </div>
          </div>
        </main>
